...
} from '../../theme/auriaIconTokens';
import { OutlineIcon } from './OutlineIcon';

/** Heroicons v2 outline paths — same glyphs as web `@/components/icons`. */
export const AURIA_ICON_PATHS = {
  search:
  ...
  panelLeft: 'M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12',
  squarePen:
  ...
  pin:
    'M12 17.25v4.5m-4.501-6.038 8.502-.001M6.75 3.75h10.5l-1.5 6 2.25 2.25H6l2.25-2.25-1.5-6Z',
  briefcase:
...
export function AuriaIcon({
  ...
  const resolvedColor = useMemo(() => {
    ...
    if (active) return ds.gray900;
    if (tertiary) return ds.gray500;
    return ds.gray600;
  }, [active, color, ds.gray500, ds.gray600, ds.gray900, tertiary]);

  return (
    <OutlineIcon
      paths={AURIA_ICON_PATHS[name]}
      size={size}
      color={resolvedColor}
